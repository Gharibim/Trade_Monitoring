...
<div id="wrapper">
	...
	<div class="shell">
        ...
        <div id='dvStockTicker' class='stockTicker'>
            ...
            <td class="style18">
        <img src="img/chart.png" width="270" height="300" /></td>
            <td>

             <h2 class="style10" align="center">Login with</h2><br />
             
        <table  class="auto-style4" align="right">
            <tr>
                
                <td class="style15"><span class="style21">User ID </span>&nbsp;&nbsp; </td>
            ...
            <tr>
                ...
                <td class="style11"><span class="style21">Password&nbsp; </span>&nbsp;&nbsp;&nbsp; </td>
                
                
                <td class="style19">
                   <asp:TextBox ID="TextBox2" TextMode="Password" runat="server" Width="132px"></asp:TextBox>
                </td>
            ...
            <tr>
                ...
                <td class="style16">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:ImageButton ID="ImageButton2" ImageUrl="img/login.png" Width="100" 
                        Height="50" runat="server" onclick="ImageButton2_Click" />
            ...
            <tr>
                ...
                <td class="style17">
                    &nbsp;</td>
                <td class="style19">
           <asp:ImageButton ID="ImageButton1" ImageUrl="img/account.png" Width="122px" 
                        Height="50px" runat="server" onclick="ImageButton1_Click" />
                </td
            ...
            <td width="100">
            <img src="img/map1.png" width="270" height="300"/></td>
