    ...
    public interface IService1
    {
       ...
       void InsertUserHoldStockDetails(int orderid, string username, string symbol, int quantity, double marketprice, string status, DateTime today, int rshares);
        ...
        DataSet GetAppointment(string username);
         ...
         [OperationContract]
       DataSet AvailableSharesStatistics();

          [OperationContract]
         DataSet BuySharesStatistics(string username);

          [OperationContract]
          DataSet SellSharesStatistics(string username);

         [OperationContract]
       DataSet SharesStatistics(string username);
