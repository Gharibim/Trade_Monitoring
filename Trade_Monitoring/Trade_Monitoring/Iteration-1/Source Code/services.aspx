...
<font size="4" color="red">Services</font>
...
* We provide a secure transaction system for the investor which enables the investor to safely make deposits and payments in our system.<br />

* Also, we provide web service to access the current share values of the companies requested by the investor.<br />

* We also provide online chat service for the investors which enables to contact with our support team.<br />

* Also, graphical analysis based on the past years shares values and predictions on the future trend of the shares will be provided<br />
</font></p>
