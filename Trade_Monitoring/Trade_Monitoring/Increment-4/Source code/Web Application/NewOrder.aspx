<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" Debug="true" AutoEventWireup="true" CodeFile="NewOrder.aspx.cs" Inherits="NewOrder" %>
    ...
    <table style="border: medium outset #FFFFFF; width: 100%; background-image: url('images/bg1.jpg');">
        <tr>
            ...
            <td class="col_w250" 
                ...
                Symbol</td>
            <td style="width: 219px" class="col_w270">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Label5" runat="server" style="color: #FF0066" Text="Label" 
        ...
        <tr>
            ...
            <td class="col_w250" 
                style="width: 191px; color: #996633; font-family: 'Times New Roman', Times, serif; font-size: small;">
                Price</td>
            <td style="width: 219px; color: #0066FF;" class="col_w270">
