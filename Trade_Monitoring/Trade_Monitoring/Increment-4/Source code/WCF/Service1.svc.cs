...
namespace StockMonitoringService
{
 ...
 public DataSet AvailableSharesStatistics()
 {

     DataSet ds = new DataSet();
     con.Open();
     SqlCommand cmd = new SqlCommand("sp_AvailableSharesStatistics", con);
     cmd.CommandText = "sp_AvailableSharesStatistics";
     cmd.CommandType = CommandType.StoredProcedure;
     SqlDataAdapter da = new SqlDataAdapter(cmd);
     da.Fill(ds);
     con.Close();
 ...
 public DataSet BuySharesStatistics(string username)
 {
     DataSet ds = new DataSet();
     con.Open();
     SqlCommand cmd = new SqlCommand("sp_BuySharesStatistics", con);
     cmd.CommandText = "sp_BuySharesStatistics";
     cmd.CommandType = CommandType.StoredProcedure;
     SqlParameter username1 = cmd.Parameters.Add("@username", SqlDbType.VarChar, 100);
     username1.Value = username;
     SqlDataAdapter da = new SqlDataAdapter(cmd);
...
public DataSet SellSharesStatistics(string username)
 {
     DataSet ds = new DataSet();
     con.Open();
     SqlCommand cmd = new SqlCommand("sp_SellSharesStatistics", con);
     cmd.CommandText = "sp_SellSharesStatistics";
     cmd.CommandType = CommandType.StoredProcedure;
     SqlParameter username1 = cmd.Parameters.Add("@username", SqlDbType.VarChar, 100);
     username1.Value = username;
     SqlDataAdapter da = new SqlDataAdapter(cmd);
...
public DataSet SharesStatistics(string username)
{
    DataSet ds = new DataSet();
    con.Open();
    SqlCommand cmd = new SqlCommand("sp_SharesStatistics", con);
    cmd.CommandText = "sp_SharesStatistics";
    cmd.CommandType = CommandType.StoredProcedure;
    SqlParameter username1 = cmd.Parameters.Add("@username", SqlDbType.VarChar, 100);
    username1.Value = username;
    SqlDataAdapter da = new SqlDataAdapter(cmd);
