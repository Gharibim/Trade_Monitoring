...
<font size="4" color="red">About us:</font>

<br />

	<p>
    <font size="2" color="purple">
* Our trade monitoring system acts as mediatory between investors and the companies.

* This system we develop acts as a service for the investors to view the present market shares of the companies and also analyze the trends in market share values. For this the investor has to first register with the system.<br />

* This analysis helps the investors to buy or sell shares. Here investor can buy shares, sell shares and update his account information.<br />

* The investor can also claim for a refund if he wish to cancel his order while buying or selling shares.<br />

* We also provide a secure transaction system which helps the investor to keep his account details safe.<br />

* Investor can view shares at any time when logged into the system. Based on the availability of the shares he/she can buy any number of shares.<br />

* This include a nominal fee of about $120 per year in return the user has access to all the share values of the current market and also analysis on the shares.<br />
</font></p>
